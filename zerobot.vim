...
map  :setlocal spell spelllang=de_de^M
map  :setlocal spell spelllang=en_us^M
map  :set nospell^M
...
10
normal zo
let s:l = 38 - ((22 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
38
